	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(-1.0F, -13.0F, -1.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(18, 7)
		...
		PartDefinition Arms = partdefinition.addOrReplaceChild("Arms",
				CubeListBuilder.create().texOffs(12, 15)
						.addBox(4.0F, -13.0F, -1.0F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 15)
						.addBox(-7.0F, -13.0F, -1.0F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Ear1 = partdefinition.addOrReplaceChild("Ear1",
				CubeListBuilder.create().texOffs(21, 14)
						.addBox(-6.0F, -18.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(9, 15)
						.addBox(-5.0F, -17.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Ear2 = partdefinition.addOrReplaceChild("Ear2",
				CubeListBuilder.create().texOffs(15, 7)
						.addBox(3.0F, -17.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 0)
						.addBox(5.0F, -18.0F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Legs = partdefinition.addOrReplaceChild("Legs",
				CubeListBuilder.create().texOffs(24, 14)
						.addBox(1.0F, -5.0F, -1.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 21)
						.addBox(-4.0F, -5.0F, -1.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(10, 26)
						.addBox(-1.0F, -11.0F, -1.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-3.0F, -18.0F, -1.0F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

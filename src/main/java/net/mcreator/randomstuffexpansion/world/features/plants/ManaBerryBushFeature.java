...
package net.mcreator.randomstuffexpansion.world.features.plants;
...
public class ManaBerryBushFeature extends DefaultFlowerFeature {
	public static final ManaBerryBushFeature FEATURE = (ManaBerryBushFeature) new ManaBerryBushFeature()

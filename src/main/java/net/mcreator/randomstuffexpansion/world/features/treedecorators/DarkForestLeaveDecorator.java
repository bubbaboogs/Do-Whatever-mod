...
public class DarkForestLeaveDecorator extends LeaveVineDecorator {
	public static final DarkForestLeaveDecorator INSTANCE = new DarkForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("dark_forest_tree_leave_decorator");

...
import net.mcreator.randomstuffexpansion.procedures.SacrificialKnifeRightClickedInAirProcedure;
...
public class SacrificialKnifeItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		SacrificialKnifeRightClickedInAirProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}

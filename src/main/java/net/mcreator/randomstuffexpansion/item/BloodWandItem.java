...
import net.mcreator.randomstuffexpansion.procedures.BloodWandRangedItemUsedProcedure;
...
public class BloodWandItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				BloodWandEntity entityarrow = BloodWandEntity.shoot(world, entity, world.getRandom(), 2f, 8, 5);
				itemstack.hurtAndBreak(1, entity, e -> e.broadcastBreakEvent(entity.getUsedItemHand()));
				entityarrow.pickup = AbstractArrow.Pickup.DISALLOWED;

				BloodWandRangedItemUsedProcedure.execute(entity, itemstack);
			}
		}
	}
}
